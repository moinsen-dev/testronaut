...
from typing import Dict, Any, List, Optional, Union, Set, Type, ClassVar
...
class LoggingSettings(BaseSettings):
    ...
    format: str = Field(
        default="structured",
        description="Logging format (structured or simple)"
    )
...
class LLMSettings(BaseSettings):
    ...
    model: str = Field(
        default="gpt-4o",
        description="The model to use for the LLM provider"
    )
...
class ExecutionSettings(BaseSettings):
    ...
    use_docker: bool = Field(
        default=True,
        description="Whether to use Docker for test execution isolation"
    )
    docker_image: str = Field(
        default="ubuntu:latest",
        description="Default Docker image for test execution"
    )
...
from testronaut.config.setup import initialize_config, update_config, get_config_path
